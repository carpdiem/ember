...
METRICS = (
    ...
    *(
    ...
    (
        "Terminal group separation, transformed",
        "term_night_pair",
        "higher",
...
function sync(){{const u=new URL(location.href);u.searchParams.set('profile',body.dataset.profile);u.searchParams.set('state',body.dataset.state);u.searchParams.set('candidate',body.dataset.focus);history.replaceState(null,'',u)}}
