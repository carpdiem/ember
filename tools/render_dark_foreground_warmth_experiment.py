...
def anatomy(slug: str, lane: str, record: dict[str, Any], metrics: dict[str, float]) -> str:
    ...
    if ordering:
        ...
        if ordering.get("human_review_override"):
            provenance.append(escape(ordering["human_review_override"]))
